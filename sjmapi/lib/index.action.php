		...
		if($GLOBALS['request']['from']=="wap"){		
			...
			if($indexs_list===false||true)
			{
						...
						foreach($indexs as $k=>$v)
						{
							...
							if($v['type']==0){
								$indexs_list[$k]['type']=2;
							}elseif($v['type']==11){
								$indexs_list[$k]['type']=9;
							}elseif($v['type']==12){
								$indexs_list[$k]['type']=10;
							}elseif($v['type']==14){
								...
								$indexs_list[$k]['type']=14;
							}elseif($v['type']==25){
								$indexs_list[$k]['type']=17;
							}elseif($v['type']==16){
								$indexs_list[$k]['type']=22;
							}elseif($v['type']==26){
								$indexs_list[$k]['type']=23;
							}elseif($v['type']==31){
								$indexs_list[$k]['type']=25;
							}elseif($v['type']==32){
								$indexs_list[$k]['type']=26;
							}
