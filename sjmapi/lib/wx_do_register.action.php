...
class wx_do_register{
	public function index()
	{
		...
		if($user){
			...
			es_cookie::set("user_name",$user['user_name'],3600*24*30);
			es_cookie::set("user_pwd",$$user['user_pwd'],3600*24*30);
			...
			if($root['status']==1)
			{
				...
				if($user_id > 0)
				{
					...
					es_session::delete("user_info");
					es_cookie::set("user_name",$user_name,3600*24*30);
					es_cookie::set("user_pwd",$rs['user_data']['user_pwd'],3600*24*30);
				}
