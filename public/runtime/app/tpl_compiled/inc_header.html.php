...
?>" name="search_form" method=post >
		...
		<ul class="search_hot_keyword">
			<?php $_from = $this->_var['hot_kw']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'kw_0_96759500_1481225401');if (count($_from)):
    foreach ($_from AS $this->_var['kw_0_96759500_1481225401']):
?>
			<li><a href="<?php echo $this->_var['kw_0_96759500_1481225401']['url']; ?>"><?php echo $this->_var['kw_0_96759500_1481225401']['txt']; ?></a></li>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</ul>
	</div>
</div><!--logo与头部搜索-->
